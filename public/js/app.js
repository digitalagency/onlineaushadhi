...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
            // commented as it was sending multiple requests
            // haven't explore why --- TODO
...
$(function () {
	...
	$('#contactForm').validate({
		...
		submitHandler: function submitHandler(form) {
			...
			$.post('/contact', $(form).serialize()).done(function (response) {
				$('#contactForm').find('button').attr('disabled', false);
				$('.contact-form-success').html(response.message).removeClass('hide').delay(3000).queue(function () {
					$(this).addClass('hide');
				});
				...
				$('.contact-form-error').removeClass('hide').delay(3000).queue(function () {
					$(this).addClass('hide');
				});
			});
	...
	$('#registrationForm').validate({
		...
		submitHandler: function submitHandler(form) {
			...
			$.post($(form).attr('action'), $(form).serialize()).done(function (response) {
				...
				$wrap.removeClass('hide').delay(3000).queue(function () {
					$(this).addClass('hide');
				});
			});
	...
	$('#passwordResetForm').validate({
		...
		submitHandler: function submitHandler(form) {
			...
			$.post($(form).attr('action'), $(form).serialize()).done(function (response) {
				$('.reset-form-success').html(response.message).removeClass('hide');
				...
				$('.reset-form-error').removeClass('hide');
			});
...
!function (t, e) {
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (i) {
    e(t, i);
...
(function (a, b, c) {
  "use strict";
  var d = b.event,
      e;d.special.smartresize = { setup: function setup() {
      b(this).bind("resize", d.special.smartresize.handler);
    }, teardown: function teardown() {
      b(this).unbind("resize", d.special.smartresize.handler);
    }, handler: function handler(a, c) {
      var d = this,
          f = arguments;a.type = "smartresize", e && clearTimeout(e), e = setTimeout(function () {
    ...
    this.element = b(c), this._create(a), this._init();
  }, b.Mason.settings = { isResizable: !0, isAnimated: !1, animationOptions: { queue: !1, duration: 500 }, gutterWidth: 0, isRTL: !1, isFitWidth: !1, containerStyle: { position: "relative" } }, b.Mason.prototype = { _filterFindBricks: function _filterFindBricks(a) {
      ...
      this.options = b.extend(!0, {}, b.Mason.settings, c), this.styleQueue = [];var d = this.element[0].style;this.originalStyle = { height: d.height || "" };var e = this.options.containerStyle;for (var f in e) {
        this.originalStyle[f] = d[f] || "";
      }this.element.css(e), this.horizontalDirection = this.options.isRTL ? "right" : "left", this.offset = { x: parseInt(this.element.css("padding-" + this.horizontalDirection), 10), y: parseInt(this.element.css("padding-top"), 10) }, this.isFluid = this.options.columnWidth && typeof this.options.columnWidth == "function";var g = this;setTimeout(function () {
      ...
      }var e = {};e.height = Math.max.apply(Math, this.colYs);if (this.options.isFitWidth) {
        var f = 0;c = this.cols;while (--c) {
          if (this.colYs[c] !== 0) break;f++;
        }e.width = (this.cols - f) * this.columnWidth - this.options.gutterWidth;
      }this.styleQueue.push({ $el: this.element, style: e });var g = this.isLaidOut ? this.options.isAnimated ? "animate" : "css" : "css",
          h = this.options.animationOptions,
          i;for (c = 0, d = this.styleQueue.length; c < d; c++) {
        i = this.styleQueue[c], i.$el[g](i.style, h);
      }this.styleQueue = [], b && b.call(a), this.isLaidOut = !0;
    }, _getColumns: function _getColumns() {
      var a = this.options.isFitWidth ? this.element.parent() : this.element,
          b = a.width();this.columnWidth = this.isFluid ? this.options.columnWidth(b) : this.options.columnWidth || this.$bricks.outerWidth(!0) || b, this.columnWidth += this.options.gutterWidth, this.cols = Math.floor((b + this.options.gutterWidth) / this.columnWidth), this.cols = Math.max(this.cols, 1);
      ...
      var c = b(a),
          ...
          f,
          g,
          h;d = Math.ceil(c.outerWidth(!0) / this.columnWidth), d = Math.min(d, this.cols);if (d === 1) f = this.colYs;else {
        e = this.cols + 1 - d, f = [];for (h = 0; h < e; h++) {
      ...
      }var m = { top: i + this.offset.y };m[this.horizontalDirection] = this.columnWidth * j + this.offset.x, this.styleQueue.push({ $el: c, style: m });var n = i + c.outerHeight(!0),
          o = this.cols + 1 - l;for (k = 0; k < o; k++) {
        this.colYs[j + k] = n;
      }
    }, resize: function resize() {
      var a = this.cols;this._getColumns(), (this.isFluid || this.cols !== a) && this._reLayout();
    }, _reLayout: function _reLayout(a) {
      var b = this.cols;this.colYs = [];while (b--) {
        this.colYs.push(0);
      ...
      if (b) {
        this._filterFindBricks(a).css({ top: this.element.height() });var d = this;setTimeout(function () {
          d._appended(a, c);
        }, 1);
...
$(function () {
	$.fn.hasAttr = function (attribute) {
		...
		if ((typeof attr === 'undefined' ? 'undefined' : _typeof(attr)) !== ( true ? 'undefined' : _typeof(undefined)) && attr !== false) return true;
		return false;
	};
	...
	$.fn.materialForm = function () {
    	...
    	$group.append($(this));
				...
				if (isType($(this), 'radio')) var $radio = $('<div class="material-radio"></div>');else var $radio = $('<div class="material-checkbox"></div>');
		...
		this.find('input, textarea').on('blur', function () {
			if (isValidType($(this))) addFilled($(this));
		});
		...
		function addFilled($el) {
			if ($el.val()) $el.addClass('filled');else $el.removeClass('filled');
		}
		...
		$('.material-select > input').on('change', function () {
			...
			$('.material-select > input').each(function () {
				...
				if (changed_id != this_id) $(this).prop('checked', false);
			});
		});
...
__webpack_require__("./resources/assets/js/jquery.material.form.js");
__webpack_require__("./resources/assets/js/jquery.masonry.min.js");
__webpack_require__("./resources/assets/js/isotope.pkgd.min.js");
__webpack_require__("./resources/assets/js/jquery.validate.min.js");
__webpack_require__("./node_modules/jquery-file-upload/js/jquery.uploadfile.js");
__webpack_require__("./node_modules/jquery-ui/ui/widgets/autocomplete.js");
