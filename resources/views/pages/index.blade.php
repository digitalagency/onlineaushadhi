    ...
    <main class="company-primary" role="main">
        ...
        <div class="home">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="associate-partners text-center">
                            <div class="row">
                                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="partners">
                                    <a href="https://www.digitalagencycatmandu.com/" target="_blank"><img src="https://www.digitalagencycatmandu.com/images/dac_logo.png" alt="Medical Digital Marketing Partner" title="Web and digital strategy Partner" ></a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 partners">
                                    <div class="partners">
                                    <a href="https://doctorsonkall.com/" target="_blank"><img src="https://doctorsonkall.com/wp-content/uploads/2018/03/logo2.png" alt="Online Medicines Suppliers" title="Group of Doctors at your doorsteps" ></a>  
                                    </div>       
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="partners">
                                    <a href="http://nepalauto.com/" target="_blank"><img src="http://nepalauto.com/wp-content/uploads/2017/05/logo.png" alt="Free Home Delivery" title="Media Partner" ></a>  
                                    </div> 
                                </div>
                            </div>
                        </section>
