                            ...
                            <div class="content__gutter-up-down">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-md-8 col-sm-8">
                                        <p>Your prescriptions has been uploaded successfully. <br/> Once verified, one of our representatives will contact you shortly.</p>

                                        <p>You can view your prescriptions <a href="{{ route('home').'#prescriptions' }}">here.</a></p>
